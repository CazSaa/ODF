...
def test_total_risk_door_max_no_evidence(paper_example_models):
    ...
    result = total_risk("Door", max, {}, *paper_example_models)
    assert result == approx(1.2811)


def test_total_risk_door_min_no_evidence(paper_example_models):
    ...
    result = total_risk("Door", min, {}, *paper_example_models)
    assert result == approx(0.4779)


def test_total_risk_lock_max_with_evidence(paper_example_models):
...
def test_total_risk_lock_min_with_evidence(paper_example_models):
...
def test_total_risk_door_sum_with_evidence(paper_example_models):
...
def test_total_risk_evidence_makes_pl_unsatisfiable(paper_example_models):
...
def test_total_risk_missing_impact_error(paper_example_models):
    ...
    with pytest.raises(MissingNodeImpactError, match="PL") as exc_info:
        total_risk("Lock", max, {"LP": True}, *paper_example_models)
    assert "attack or fault" in str(exc_info.value)


def test_total_risk_unused_evidence(caplog, paper_example_models):
...
def test_create_mtbdd_structure_simple(caplog, paper_example_models):
    """Test MTBDD structure for a simple BDD with OP and non-OP vars."""
    attack_tree, fault_tree, object_graph = paper_example_models
...
def test_create_mtbdd_structure_only_op(paper_example_models):
...
def test_create_mtbdd_structure_only_non_op(paper_example_models):
...
def test_create_mtbdd_structure_nested(paper_example_models):
...
def test_create_mtbdd_structure_negation(paper_example_models):
...
def test_create_mtbdd_structure_terminal_true(paper_example_models):
...
def test_create_mtbdd_structure_terminal_false(paper_example_models):
